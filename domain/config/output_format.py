...
OUTPUT_FORMATS: Dict[OutputStyle, OutputFormatConfig] = {
    OutputStyle.XML: OutputFormatConfig(
        id="xml",
        name="XML",
        description="Structured XML conforming to Repomix standard",
        benefits=[
            "LLM understands code structure better",
            "Reduces hallucination regarding file paths",
    ...
    OutputStyle.PLAIN: OutputFormatConfig(
        id="plain",
        name="Plain Text",
        description="Raw text, minimal formatting",
        benefits=[
            "Most token-efficient",
            "No extra tags or markdown",
            "For small model contexts",
        ],
        file_extension=".txt",
    ),
}
